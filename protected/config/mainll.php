...
return array(
	...
	'params'=>array(
		...
		'adminEmail'=>'webmaster@example.com',
                'pattern' => '/var/www/pattern/',
            //LDAP -> Sólo para buscar el UID de los usuarios
                'ldap' => array(
                    'host' => 'ns2.saime.gob.ve',
                    'port' => 389,
                    'userAdmin' => 'uid=webldapadmin,ou=usuarios especiales,dc=saime,dc=gob,dc=ve',
                    'passAdmin' => 'PUkjrPo376cE',
                    'dn' => 'ou=personas,dc=saime,dc=gob,dc=ve'
                ),
	),
);