 ...
 */
class TbFileUpload2 extends CJuiInputWidget {
     ...
     */
    public $formView = 'bootstrap.views.fileupload.form1';

    /**
     * @var string name of the upload view to be rendered
     */
    public $uploadView = 'bootstrap.views.fileupload.upload1';
    ...
    public function init() {
        if ($this->uploadTemplate === null) {
            $this->uploadTemplate = "#template-upload1";
        }
