...
<script id="template-upload" type="text/x-tmpl">
    ...
    <td class="name">Tipo de Documento
        ...
        <option value ='378'>ACTA DE CONFORMACIÓN DE LA COMISION PROMOTORA</option>
        <option value ='379'>CARTA FUNDACIONAL DEL REFERÉNDUM</option>
        <option value ='380'>ACTA DE ESCRUTINIOS DEL REFERÉNDUM APROBATORIO</option>
        </select>
