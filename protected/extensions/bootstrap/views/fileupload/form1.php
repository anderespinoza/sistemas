<script>
    ...
    $('input:file').click(function() {
        cantFoto = parseInt(0);
        $('.CantidadFoto').each(function() {          
                cantFoto++;

        });
        if (cantFoto > 1) {
            bootbox.alert('<b>No puede ingresar mas de 2 Imagenes!<b>');
            return false;
        }
...
<div class="fileupload-buttonbar">
    ...
    <span id='BtnAdjuntar' style='float:right; margin-right: 30px;' class="btn btn-success fileinput-button BtnAdjuntar"> <i class="icon-plus icon-white"></i>
