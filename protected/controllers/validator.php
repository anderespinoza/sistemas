...
//  public function isMayor($desde, $hasta) {
//        $fecha_mov_mig = explode("/", $desde);
//        $fecha_mov_mig2 = explode("/", $hasta);
//        
//        if($fecha_mov_mig[2] > $fecha_mov_mig2[2]){
//            return TRUE;
//        }
//        if(($fecha_mov_mig[2] == $fecha_mov_mig2[2]) && ($fecha_mov_mig[1] > $fecha_mov_mig2[1])){
//            return TRUE;
//        }
//        if(($fecha_mov_mig[1] == $fecha_mov_mig2[1]) && ($fecha_mov_mig[0] > $fecha_mov_mig2[0])){
//            return TRUE;
//        }
//            
//        return FALSE;
//    }
   ...
   public static function isMayor($fecha1, $fecha2) {
//       print_r(date('d/m/Y'));
//       echo'-----';
//print_r(date('d/m/Y'));exit;
      if(date("dd/mm/yyyy",strtotime($fecha1)) > date("dd/mm/yyyy",strtotime($fecha2))){
      return true;}
      return false;
   }
