...
//        $(".error").css("display", ret ? "none" : "inline");
    ...
    $(".string").bind("keypress", function (e) {
        var keyCode = e.which ? e.which : e.keyCode
        var ret = ((keyCode > 64 && keyCode < 125) || (keyCode >= 192 && keyCode <= 255) || specialKeys.indexOf(keyCode) != -1 || keyCode ===32);
//        $(".error").css("display", ret ? "none" : "inline");
        return ret;
    });
